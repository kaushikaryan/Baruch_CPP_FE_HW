...
NumType computeSE(vector<NumType> draws, NumType r, NumType T)
{
	...
	NumType std_dev = computeSD(draws, r, T);
...
int main()
{
	...
	vector<long> NT_values = {2, 5, 10, 100, 500, 1000};
	vector<long> NSIM_values = {100, 1000, 10000, 100000, 1000000};
