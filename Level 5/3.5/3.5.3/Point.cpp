...
Point::Point(const double xVal, const double yVal) : Shape(), m_x(xVal), m_y(yVal) {}

// Constructor that accepts a single double value
Point::Point(double val) : Shape(), m_x(val), m_y(val) {}

// Destructor
Point::~Point()
{
	cout << "Destructor called for Point Class. " << endl;
}
...
string Point::ToString() const
{
	...
	// Format the point as Point(x, y), ID: id
