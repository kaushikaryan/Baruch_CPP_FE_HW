...
// Default constructor
Circle::Circle() : m_radius(0), m_centre(0, 0) {}

// Copy constructor 
Circle::Circle(Circle& circle) : m_centre(circle.m_centre), m_radius(circle.m_radius) {}

// Constructor that accepts center point and radius
Circle::Circle(const Point& point, const double& radius) : m_centre(point), m_radius(radius) {}
