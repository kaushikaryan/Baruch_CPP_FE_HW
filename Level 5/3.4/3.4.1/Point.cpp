...
{
	cout << "Default constructor for Point class called." << endl;
}

// Copy constructor
Point::Point(const Point& point) : m_x(point.m_x), m_y(point.m_y)
{
	cout << "Copy constructor for Point class called." << endl;
}

// Constructor that accepts X and Y coordinates
Point::Point(const double xVal, const double yVal) : m_x(xVal), m_y(yVal)
{
	cout << "Custom constructor that accepts X and Y coordinates for Point class called." << endl;
}

// Constructor that accepts a single double value
Point::Point(double val) : m_x(val), m_y(val)
{
	cout << "Custom constructor that accepts a single double value for Point class called." << endl;
}

// Destructor
Point::~Point()
{
	cout << "Destructor for Point class called." << endl;
}
...
{
	cout << "Assignment operator for Point class called." << endl;
