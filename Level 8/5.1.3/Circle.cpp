...
// Copy constructor 
Circle::Circle(const Circle& circle) : Shape(circle), m_centre(circle.m_centre), m_radius(circle.m_radius) {}
...
std::string Circle::ToString() const
{
	...
	// Format the Circle as Circle: [(Point(x, y), ID: id), Radius: radius], ID: id
	stream << "Circle: [(" << m_centre.ToString() << "), Radius: " << m_radius << "], " << s;
