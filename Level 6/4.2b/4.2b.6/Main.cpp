...
int main()
{
	...
	// Copy constuctor
	Stack<int, 5> stackCopy(stack);

	// Assignment operator
	//Stack<int, 6> stackAssignment = stackCopy;	// Throws error: 'initializing': cannot convert from 'Stack<int,5>' to 'Stack<int,6>'
	Stack<int, 5> stackAssignment = stackCopy;
